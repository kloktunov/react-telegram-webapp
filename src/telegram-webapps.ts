export declare namespace TelegramWebApps {
	...
	interface HapticFeedback {
	   ...
	   */
	  impactOccurred(style: 'light' | 'medium' | 'heavy' | 'rigid' | 'soft'): HapticFeedback | undefined
	  /**
	   ...
	   */
	  notificationOccurred(type: 'error' | 'success' | 'warning'): HapticFeedback | undefined
	  /**
	   ...
	   */
	  selectionChanged(): HapticFeedback | undefined
	}
